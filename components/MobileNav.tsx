            ...
            <nav className="flex-1 space-y-1 p-3">
              ...
              {isAdmin && (
                <>
                  ...
                  <Link href="/admin/pricing" onClick={() => setOpen(false)} className={`${item} text-ink-700 hover:bg-ink-50`}>
                    Pricing
                    <span className="rounded-full bg-amber-100 px-1.5 py-0.5 text-[9px] font-bold text-amber-700">Admin</span>
                  </Link>
                  <Link href="/admin/payments" onClick={() => setOpen(false)} className={`${item} text-ink-700 hover:bg-ink-50`}>
                    Payments (sandbox)
                    <span className="rounded-full bg-amber-100 px-1.5 py-0.5 text-[9px] font-bold text-amber-700">Admin</span>
                  </Link>
              ...
              <Link href="/billing" onClick={() => setOpen(false)} className={`${item} text-ink-700 hover:bg-ink-50`}>Billing</Link>
            </nav>
