...
const FAQ = [
  ...
  { q: "What is the difference between Trial and Starter?", a: "Trial is free and lets you capture one show (1 exhibition, up to 25 connections, up to 25 opportunities) to see the value. Starter unlocks unlimited exhibitions, connections and opportunities, plus CSV export. Reports are included on the trial too, but CSV export is not available on the trial plan." },
